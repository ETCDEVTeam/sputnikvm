...
#[test] fn arith() { assert_eq!(test_transaction("arith", &TESTS["arith"], true), true); }
#[test] fn boolean() { assert_eq!(test_transaction("boolean", &TESTS["boolean"], true), true); }
#[test] fn mktx() { assert_eq!(test_transaction("mktx", &TESTS["mktx"], true), true); }
#[test] fn suicide() { assert_eq!(test_transaction("suicide", &TESTS["suicide"], true), true); }
